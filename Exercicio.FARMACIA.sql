...
insert into tb_categoria (remédio, cuidado_pessoal, beleza)
values("Sem Prescrição", "Íntimo", "Acessóris");

insert into tb_produto (nome, categoria, valor)
values("Morfina", "Tarja Preta", 80);
insert into tb_produto (nome, categoria, valor)
values("Plasil", "Sem Prescrição", 15);
insert into tb_produto (nome, categoria, valor)
values("Rímel", "Maquiagem", 26);
insert into tb_produto (nome, categoria, valor)
...
select * from tb_categoria inner join tb_produto on tb_produto.id = tb_produto.id;
